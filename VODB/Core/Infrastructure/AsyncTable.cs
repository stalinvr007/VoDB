...
{
    internal class AsyncTable : Table
    {
            ...
            mappingTask.ContinueWith(task =>
                                         {
                                             ...
                                             foreach (Field field in InnerTable.CollectionFields)
                                             {
                                             ...
                                             foreach (
                                                 Field field in
                                                     InnerTable.Fields.Where(f => f.Property.GetGetMethod().IsVirtual))
                                             {
        ...
        {
            get { return InnerTable.CommandsHolder; }
            set { InnerTable.CommandsHolder = value; }
        }


        public override IEnumerable<Field> Fields
        {
            get { return InnerTable.Fields; }
            set { InnerTable.Fields = value; }
        }

        public override IEnumerable<Field> CollectionFields
        {
            get { return InnerTable.CollectionFields; }
            set { InnerTable.CollectionFields = value; }
        }

        public override IEnumerable<Field> KeyFields
        {
            get { return InnerTable.KeyFields; }
            set { InnerTable.KeyFields = value; }
        }
        ...
        {
            get { return InnerTable.FieldsByBind; }
            set { InnerTable.FieldsByBind = value; }
        }

        public override IDictionary<string, Field> FieldsByName
        {
            get { return InnerTable.FieldsByName; }
            set { InnerTable.FieldsByName = value; }
        }

        public override IDictionary<string, Field> FieldsByPropertyName
        {
            get { return InnerTable.FieldsByPropertyName; }
            set { InnerTable.FieldsByPropertyName = value; }
        }
    }
}